...
import 'package:teqinvalleyproject/Screen/l_getstarted_screen/controller/login_get_start_controller.dart';
...
class LoginGetstartedScreen extends StatelessWidget {
   LoginGetstartedScreen({super.key});
  var controller = Get.put(LoginGetStartController());
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Let’s get you all set up so you can access your personal account.",style: AppTextStyle.pw400.copyWith(
                            color: white
                        ),),
                        SizedBox(
                          height: 3.h,
                        ...
                        textFieldWidget(context,
                            ...
                            obsecure: false, icon: Icons.email_outlined,
                            controller: controller.email,
                            hint: "Enter your email", title: "Email Address"),
                        SizedBox(
                          height: 3.h,
                        ),
                        Obx(
                            ()=> textFieldWidget(context,
                              ...
                              child: GestureDetector(
                                ...
                                child:
                                  ...
                                  Icons.visibility_outlined:Icons.visibility_off_outlined,color: Colors.grey.shade500,),
                        ...
                        Align(
                          ...
                          child: GestureDetector(
                            ...
                            child: Text("Forgot Password ?",style: AppTextStyle.pw400.copyWith(
                              fontSize: 12.px
                            ),),
                          ),
                        ),
